...
template <typename Character_Type>
Text_Index_Buckets<Character_Type>::Text_Index_Buckets (std::vector<Character_Type> const &text)
{
...
template <typename Character_Type>
void Text_Index_Buckets<Character_Type>::generate_bucket_begins ()
{
...
template <typename Character_Type>
void Text_Index_Buckets<Character_Type>::generate_bucket_ends ()
{
  std::partial_sum(character_counts_.begin(), character_counts_.end(), bucket_ends_.begin());
}

template <typename Character_Type>
int32_t Text_Index_Buckets<Character_Type>::get_begin (Character_Type character)
{
  return (bucket_begins_[character]++);
}

template <typename Character_Type>
int32_t Text_Index_Buckets<Character_Type>::get_end (Character_Type character)
{
